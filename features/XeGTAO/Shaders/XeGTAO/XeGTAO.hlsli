...
void XeGTAO_Denoise( const uint2 pixCoordBase, const GTAOConstants consts, Texture2D<uint> sourceAOTerm, Texture2D<lpfloat> sourceEdges, SamplerState texSampler, RWTexture2D<uint> outputTexture, const uniform bool finalApply )
{
    ...
    AOTermType visQ0[4];    XeGTAO_DecodeGatherPartial( GatherAlternative( consts, sourceAOTerm, gatherCenter, int2( 0, 0 ) ), visQ0 );
    AOTermType visQ1[4];    XeGTAO_DecodeGatherPartial( GatherAlternative( consts, sourceAOTerm, gatherCenter, int2( 2, 0 ) ), visQ1 );
    AOTermType visQ2[4];    XeGTAO_DecodeGatherPartial( GatherAlternative( consts, sourceAOTerm, gatherCenter, int2( 0, 2 ) ), visQ2 );
    AOTermType visQ3[4];    XeGTAO_DecodeGatherPartial( GatherAlternative( consts, sourceAOTerm, gatherCenter, int2( 2, 2 ) ), visQ3 );
