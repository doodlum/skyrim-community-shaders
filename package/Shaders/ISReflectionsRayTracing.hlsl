...
#		ifdef VR
				...
				&& !fromOtherEye ||
			(fromOtherEye && isOutsideFrame(VR::ConvertMonoUVToOtherEye(iterationUvDepthDR, eyeIndex, true).xy, true))
#		endif
		) {
...
#		ifdef VR
	...
	float2 otherEyeUvResultScreenCenterOffset = VR::ConvertMonoUVToOtherEye(GetDynamicResolutionUnadjustedScreenPosition(uvDepthFinalDR), eyeIndex).xy - 0.5;
