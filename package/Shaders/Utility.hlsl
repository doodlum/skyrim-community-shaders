...
VS_OUTPUT main(VS_INPUT input)
{
    ...
    positionCS = mul(CameraViewProj[0], positionWS);
#else
    precise float4x4 modelViewProj = mul(CameraViewProj[0], World);
    ...
    normalVS = mul(CameraView[0], float4(normalMS, 0)).xyz;
#else
    normalVS = mul(mul(CameraView[0], World), float4(normalMS, 0)).xyz;
#endif
