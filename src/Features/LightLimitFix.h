...
public:
	...
	bool AddCachedParticleLights(eastl::vector<LightData>& lightsData, LightLimitFix::LightData& light, ParticleLights::Config& config, int eyeIndex = 0, RE::BSGeometry* a_geometry = nullptr, double timer = 0.0f);
