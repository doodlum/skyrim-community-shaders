...
-   **[Vanilla Replica Validation](./vanilla-replica-validation.md)** - Perf (+16.8%), structural validation (instval/stateval), and the 50-location visual null-test sweep (48/50 pass)
