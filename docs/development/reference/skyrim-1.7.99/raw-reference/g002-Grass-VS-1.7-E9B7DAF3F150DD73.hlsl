...
void main(
  ...
  out float3 o5 : POSITION1,
  out float3 o6 : POSITION2)
{
  ...
  o5.x = dot(cb2[8].xyzw, r4.xyzw);
  o5.y = dot(cb2[9].xyzw, r4.xyzw);
  o5.z = dot(cb2[10].xyzw, r4.xyzw);
  r0.w = 3.1415925 * r1.x;
  r0.w = cos(r0.w);
  ...
  r0.w = 1;
  o6.x = dot(cb2[12].xyzw, r0.xyzw);
  o6.y = dot(cb2[13].xyzw, r0.xyzw);
  o6.z = dot(cb2[14].xyzw, r0.xyzw);
  return;
}