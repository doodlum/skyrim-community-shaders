...
void main(
  ...
  out float3 o4 : POSITION1,
  out float3 o5 : POSITION2)
{
  ...
  r0.y = 1 + -r0.y;
  o0.w = dot(cb2[3].xyzw, r4.xyzw);
  r5.x = v5.z;
  r5.yz = v6.zw;
  p1.x = saturate(dot(cb2[18].xyz, r5.xyz));
  r0.w = asuint(cb7[0].x) >> 2;
  r1.y = asint(cb7[0].x) & 3;
  r0.w = dot(cb8[r0.w+0].xyzw, icb[r1.y+0].xyzw);
  p1.x = r0.y * r0.w;
  o1.xy = v1.xy;
  o2.xyz = v4.www * v3.xyz;
  o3.x = dot(cb2[4].xyzw, r4.xyzw);
  o3.y = dot(cb2[5].xyzw, r4.xyzw);
  o3.z = dot(cb2[6].xyzw, r4.xyzw);
  o4.x = dot(cb2[8].xyzw, r4.xyzw);
  o4.y = dot(cb2[9].xyzw, r4.xyzw);
  o4.z = dot(cb2[10].xyzw, r4.xyzw);
  r0.w = 3.1415925 * r1.x;
  r0.w = cos(r0.w);
  ...
  r0.w = 1;
  o5.x = dot(cb2[12].xyzw, r0.xyzw);
  o5.y = dot(cb2[13].xyzw, r0.xyzw);
  o5.z = dot(cb2[14].xyzw, r0.xyzw);
  return;
}