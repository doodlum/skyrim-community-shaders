  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.xyzw = max(float4(0,0,0,0), r5.xyzw);
  r5.xyzw = min(r5.xyzw, r3.xyxy);
  r3.x = t2.Sample(s2_s, r5.xy).x;
  r3.y = t2.Sample(s2_s, r5.zw).x;
  if (r2.z != 0) {
    r2.z = cmp(0.999998987 < r2.w);
    r2.z = r2.z ? 0.222222224 : 0.111111112;
    r2.w = r2.w + r1.w;
    r4.w = cmp(0.999998987 < r3.z);
    ...
    r2.z = r3.z + r2.z;
    r2.w = r2.w + r4.x;
    r3.z = cmp(0.999998987 < r4.y);
    r3.z = r3.z ? 0.111111 : 0;
    r2.z = r3.z + r2.z;
    r2.w = r2.w + r4.y;
    r3.z = cmp(0.999998987 < r4.z);
    r3.z = r3.z ? 0.111111 : 0;
    r2.z = r3.z + r2.z;
    r2.w = r2.w + r4.z;
